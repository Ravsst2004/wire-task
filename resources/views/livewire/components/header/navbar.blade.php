<nav class="bg-gray-900 border-gray-700">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="{{ $isMenuOpen ? 'block' : 'hidden' }} w-full md:block md:w-auto" id="navbar-dropdown">
      <ul
        ...
        @endauth
        @guest
          <livewire:components.header.nav-link title="Login" href="/login" :active="request()->routeIs('login')" />
        @endguest
      </ul>
    </div>
  </div>
