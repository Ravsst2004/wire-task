  ...
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
      <ul
        ...
        <x-header.nav-link href="/" :active="request()->routeIs('home')">Home</x-header.nav-link>
        @auth
          <x-header.nav-link href="/task" :active="request()->routeIs('task')">Tasks</x-header.nav-link>
